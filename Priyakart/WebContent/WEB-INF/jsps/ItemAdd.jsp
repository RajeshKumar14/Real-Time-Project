   ...
   <form  name="itemForm" action="insertItem" method="POST" class="form-horizontal" role="form">
    <div class="col-md-4 col-sm-6 col-xs-12">
      <div class="text-center">
        ...
        <input type="file" name="itemPictureName1" class="text-center center-block well well-sm">
        <input type="file" name="itemPictureName2" class="text-center center-block well well-sm">
        <input type="file" name="itemPictureName3" class="text-center center-block well well-sm">
        <input type="file" name="itemPictureName4" class="text-center center-block well well-sm">
        <input type="file" name="itemPictureName5" class="text-center center-block well well-sm">
      </div>
    </div>
    <!-- edit form column -->
    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
       <div class="alert alert-info alert-dismissable">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-3">
            <input class="form-control" name="itemMrp" type="text" placeholder="Item price">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-3">
            <input class="form-control" name="marginDiscount" type="text" placeholder="Discount %">
          </div>
        </div>
         <div class="form-group">
          ...
          <div class="col-lg-3">
            <input class="form-control" name="rebateValue" type="text" placeholder="Rebate value">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-lg-3">
            <input class="form-control" name="specialServiceCost" type="text" placeholder="Special Service Cost">
          </div>
        </div>
        <div class="form-group">
