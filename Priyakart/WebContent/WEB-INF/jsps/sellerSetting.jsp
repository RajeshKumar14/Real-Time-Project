    ...
    <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
      ...
      <form class="form-horizontal" role="form">
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input class="form-control" value="${sellerObj.sellerFirstName}" type="text">
          </div>
        </div>
        <div class="form-group">
          <label class="col-lg-3 control-label">Last name</label>
          <div class="col-lg-8">
            <input class="form-control" value="${sellerObj.sellerLastName}" type="text">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-lg-4">
            <input class="form-control" value="" type="text" placeholder="Enter Secondry Email">
          </div>
        </div>
         <div class="form-group">
