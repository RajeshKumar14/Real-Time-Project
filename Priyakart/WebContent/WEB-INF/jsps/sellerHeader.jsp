		...
		<ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
		     ...
		     <ul class="dropdown-menu">
               <li><a href="sellerPro"><span class="glyphicon glyphicon-user"></span>Profile</a></li>
               <li><a href="sellerSett"><span class="glyphicon glyphicon-cog"></span>Setting</a></li>
               <li><a href="sellerChangePwd"><span class="glyphicon glyphicon-edit"></span>Change Password</a></li>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown" >
		   ...
		   <ul class="dropdown-menu">
            ...
            <li><a href="trackApprovalItem">Track Approval Item</a></li>
            <li><a href="trackNonApprovalItem">Track Non-Approval Item</a></li>
          </ul> 
		</li>
		<li class="dropdown" >
