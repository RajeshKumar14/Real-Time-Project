...
<%@include file="sellsHeader.jsp" %>
 <section id="content-wrapper">
   <div id="content">
        ...
        <table border="1">
            <thead><tr><th>Item</th><th>Amount (Rs.)</th></tr></thead><tbody>
             <tr><th scope="row">Selling Price (decided by you)</th><td>1500</td></tr>
             <tr><th scope="row">Commission Fee<span style="font-size:12px;"> (varies across sub-categories/verticals)</span></th>
